...
# ---------------------------------------------------
st.set_page_config(
    page_title="Dashboard Analisa Tunggakan - JR Lhokseumawe", 
    page_icon="🏢", 
    layout="wide"
)
...
if df.empty:
    ...
    st.subheader(f"📊 Ringkasan Matriks Utama ({selected_cabang})")[cite: 3]
    ...
    # ---------------------------------------------------
    # 9. TABEL DETAIL & DOWNLOAD (EXCEL & CSV)[cite: 3]
    # ---------------------------------------------------
